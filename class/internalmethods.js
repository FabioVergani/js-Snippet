...
var myClass=function(){
  function internalmethod(instancecaller){//this===window
	  console.info('internalmethod',instancecaller);
  }
  var counter=666;
  return aRawObj({
  property1:{value:true,writable:true},
  property2:{value:"Hello"},
  method1:{value:function(){internalmethod(this);console.log(this.property1);console.log(++counter);}} 
 });
}();
//-
console.dir(myClass);
